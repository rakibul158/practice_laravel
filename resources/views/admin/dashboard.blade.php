...
<head>
    ...
    <title>Next Sidebar Navigation System Example</title>
    <link href="https://www.jqueryscript.net/css/jquerysctipttop.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootswatch/4.6.0/flatly/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('admin/css/next-sidebar.css') }}" />
    ...
    <div class="sidebar-inner">
        ...
        <ul class="sidebar-menu scrollable position-relative pt-3">
          ...
          <span class="icon-holder">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link wave-effect dropdown-toggle" href="#">
          <span class="icon-holder">
...
<div class="container-wide">
    ...
    <div class="container mt-5">
        ...
        <div id="carbon-block" class="my-3" align="center"></div>
        <div class="my-3" align="center"><script type="text/javascript"><!--
    ...
    <script src="{{ asset('admin/js/next-sidebar.js') }}"></script>
    <script type="text/javascript">
